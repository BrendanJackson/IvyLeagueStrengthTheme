...
//        wp_enqueue_style( 'wp-bootstrap-starter-bootstrap-css', get_template_directory_uri() . '/inc/assets/presets/theme-option/materia-custom' );
        wp_enqueue_style( 'wp-bootstrap-starter-fontawesome-cdn', get_template_directory_uri() . '/inc/assets/css/fontawesome.min.css' );
        wp_enqueue_style ('theme-style', get_template_directory_uri().'/inc/assets/css/presets/theme-option/materia-custom');
